const Lsi = {
  ...
  about: {
    header: {
      cs: "O aplikaci logBook",
      en: "About application logBook",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní logBook.",
      en: "You can buy your own logBook.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci logBook.",
      en: "You don't have rights to initialize this logBook.",
    },
  },
